...
import com.bboyhan.cloud.annotation.DbName;
import com.bboyhan.cloud.config.dbsource.DynamicDataSourceContextHolder;
...
public class ChooseDbAspect {
    ...
    @Pointcut("@annotation(com.bboyhan.cloud.annotation.DbName)")
